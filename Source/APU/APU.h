...
{
    SNDCHIP_NONE  = 0,
    SNDCHIP_VRC6  = 1,			// Konami VRCVI
    SNDCHIP_VRC7  = 2,			// Konami VRCVII
    SNDCHIP_FDS	  = 4,			// Famicom Disk Sound
    SNDCHIP_MMC5  = 8,			// Nintendo MMC5
    SNDCHIP_N163  = 16,			// Namco N-106
    SNDCHIP_S5B	  = 32			// Sunsoft 5B
};
